...
$TP = [
    'pl' => [
        ...
        'ask_stop' => 'Czy na pewno chcesz zatrzymać usługę SvxLink? Znikniesz z sieci.',
    ...
    'en' => [
        ...
        'btn_stop_svx' => '🛑 Stop SvxLink',
        'ask_stop' => 'Are you sure you want to stop the SvxLink service?',
...
<form method="post" id="power-form">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap:15px; margin-bottom: 20px;">
        ...
        <button type="submit" name="stop_srv" class="btn btn-orange" onclick="return confirm('<?php echo $TP[$lang]['ask_stop']; ?>')"><?php echo $TP[$lang]['btn_stop_svx']; ?></button>
        <button type="submit" name="reboot_device" class="btn btn-red" onclick="return confirm('<?php echo $TP[$lang]['ask_reb']; ?>')"><?php echo $TP[$lang]['btn_reb']; ?></button>
